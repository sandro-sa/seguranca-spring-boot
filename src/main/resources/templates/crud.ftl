...
<body>
  <nav class="navbar navbar-expand-sm bg-dark">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a href="/logout" class="nav-link btn btn-secondary">Sair da aplicação</a></li>
        </ul>
    </nav>
    ...
    <div class="container-fluid">
        ...
        <#if cidadeAtual??>
            ...
            <input maxlength="2" required type="hidden" name="estadoAtual" value="${(cidadeAtual.estado)!}" />
        <#else>
